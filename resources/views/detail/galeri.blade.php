  ...
  <main class="main">
    ...
    <section id="hero" class="hero section">
      ...
      <div class="container text-center">
        <div class="d-flex flex-column justify-content-center align-items-center">
          <h1 data-aos="fade-up">Profile UMKM</br><span>Galeri Warna Alam</span></h1>
          ...
          <div class="d-flex mt-4" data-aos="fade-up" data-aos-delay="200">
            ...
            <a href="https://www.youtube.com/watch?v=26pHeEjsAz8" class="glightbox btn-watch-video d-flex align-items-center"><i class="bi bi-play-circle"></i><span>Watch Video</span></a>
          </div>
          ...
          <div class="col-xl-3 col-lg-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-item d-flex">
              ...
              <div>
                ...
                <p class="description">2010 /13 tahun</p>
              </div>
            </div>
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6 content" data-aos="fade-up" data-aos-delay="100">
            <p class="who-we-are">Produk Galeri Warna Alam</p>
            <h3>Warisan budaya
                turun-temurun, ringan, lembut, tidak
                mencolok dan elegan</h3>
            <p class="fst-italic">
                Motif songket produksi
                kelompok Mardiah :
            </p>
            <ul>
              <li><i class="bi bi-check-circle"></i> <span>Songket Lepus</span></li>
              <li><i class="bi bi-check-circle"></i> <span>Songket Rakam</span></li>
              <li><i class="bi bi-check-circle"></i> <span>Songket Bunga Intan</span></li>
              <li><i class="bi bi-check-circle"></i> <span>Songket Bunga Cina</span></li>
              <li><i class="bi bi-check-circle"></i> <span>Songket Cantik Manis</span></li>
            </ul>
            <p>
              Produktivitas 20 pcs/hari
              alat-alat perkebunan dengan
              bahan baku dari pipa besi
              bekas atau per mobil
              berkualitas tinggi.               
            </p>
          </div>
    ...
    <section id="features" class="features section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Tentang Galeri Warna Alam</h2>
        {{-- <p>Galeri Warna Alam membuka peluang bagi investor untuk
            ...
            <ul class="nav nav-tabs" data-aos="fade-up" data-aos-delay="100">
              <li class="nav-item">
                <a class="nav-link active show" data-bs-toggle="tab" data-bs-target="#features-tab-1">
                  ...
                  <div>
                    ...
                    <p>
                        Terdapat 6 unit Toko Retail dan Terdapat 6 unit usaha di bidang
                        akomodasi seperti hotel dan resort 
                    </p>
                  </div>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" data-bs-target="#features-tab-2">
                  ...
                  <div>
                    <h4 class="d-none d-lg-block">Pemasaran produk</h4>
                    <p>
                        Dengan mengikuti pameran tingkat
                        Nasional dan Internasional, mulai
                        dari Jakarta, Lombok, Malaysia,
                        Filipina hingga Dubai dan Hongkong. 
                    </p>
                  </div>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" data-bs-target="#features-tab-3">
                  ...
                  <div>
                    <h4 class="d-none d-lg-block">Harga, omset dan regenerasi</h4>
                    <p>
                        Harga kompetitif mulai dari 1
                        juta hingga 8,5 juta rupiah dan
                        kualitas songket yang tidak
                        perlu diragukan lagi. T
                    </p>
                  </div>
                </a>
              </li>
          ...
          <div class="col-lg-6">
            ...
            <div class="tab-content" data-aos="fade-up" data-aos-delay="200">
              ...
              <div class="tab-pane fade active show" id="features-tab-1">
                <img src="assets/img/galeri/3.jpg" alt="" style="margin-top:70px" class="img-fluid">
              </div><!-- End Tab Content Item -->

              <div class="tab-pane fade" id="features-tab-2">
                <img src="assets/img/galeri/4.jpg" alt="" style="margin-top:70px" class="img-fluid">
              </div><!-- End Tab Content Item -->

              <div class="tab-pane fade" id="features-tab-3">
                <img src="assets/img/galeri/5.jpg" alt="" style="margin-top:70px" class="img-fluid">
              </div><!-- End Tab Content Item -->
            </div>
      ...
      <div class="container">
        ...
        <div class="row gy-4 justify-content-between features-item">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            <img src="assets/img/galeri/6.jpg" class="img-fluid" alt="" style="max-height : 450px; max-width: 450px">
          </div>

          <div class="col-lg-6 d-flex align-items-center" data-aos="fade-up" data-aos-delay="200">
            <div class="content">
              <h3>Sentra tenun kain songket</h3>
              <p>
                Terletak 35 Km dari Kota
                Palembang , Ilir merupakan Sentra
                Tenun Kain Songket, terkenal
                dengan sebutan ‘Kampung Tenun
                Songket' sejak 2010       
              </p>
        ...
        {{-- <div class="row gy-4 justify-content-between features-item">
          ...
          <div class="col-lg-5 d-flex align-items-center order-2 order-lg-1" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="content">
              <h3>Media Sosial</h3>
              <p>
                Sekilas Tentang Usaha Galeri Warna Alam
              </p>
              <ul>
        ...
        <div class="row g-5">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-item item-orange position-relative">
              ...
              <div>
                ...
                <p>(a) Kain songket, (b) kain biasa,
                    (c) Kain benang emas, (d) Kain
                    Jumputan</p>
                {{-- <a href="#" class="read-more stretched-link">Learn More <i class="bi bi-arrow-right"></i></a> --}}
              </div>
            </div>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="400">
            <div class="service-item item-red position-relative">
              ...
              <div>
                ...
                <p>BNI dab Cita Tenun Indonesia
                    (2010-2022)
                    </p>
                {{-- <a href="#" class="read-more stretched-link">Learn More <i class="bi bi-arrow-right"></i></a> --}}
              </div>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="500">
            <div class="service-item item-indigo position-relative">
              ...
              <div>
                <h5>Omset</h5>
                <p>IDR. 10.000.000 – 30.000.000/bulan</p>
                {{-- <a href="#" class="read-more stretched-link">Learn More <i class="bi bi-arrow-right"></i></a> --}}
              </div>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="600">
            <div class="service-item item-pink position-relative">
              ...
              <div>
                ...
                <p>Lebih rendah dibandingkan hasil
                    produksi</p>
                {{-- <a href="#" class="read-more stretched-link">Learn More <i class="bi bi-arrow-right"></i></a> --}}
              </div>
            </div>
    ...
    <div class="row gy-4">
      <div class="col-lg-6">
        <div class="info-item d-flex flex-column justify-content-center align-items-center" data-aos="fade-up" data-aos-delay="200">
          ...
          <h3>Alamat</h3>
          <p>Desa Penimbung - Inderalaya, Ogan Ilir Sumatera Selatan</p>
        </div>
      </div><!-- End Info Item -->
