  ...
  <main class="main">
    ...
    <section id="hero" class="hero section">
      ...
      <div class="container text-center">
        <div class="d-flex flex-column justify-content-center align-items-center">
          <h1 data-aos="fade-up">Profile UMKM</br><span>Aidil Konveksi</span></h1>
          ...
          <div class="col-xl-3 col-lg-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-item d-flex">
              ...
              <div>
                ...
                <p class="description">1993 /30 tahun</p>
              </div>
            </div>
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6 content" data-aos="fade-up" data-aos-delay="100">
            <p class="who-we-are">Produk Aidil Konveksi</p>
            <h3>Kami warga Desa Ulak Kerbau Lama, lebih dari 50%
                berprofesi sebagai
                tukang jahit </h3>
            <p class="fst-italic">
              Produk Aidil Konveksi :
            </p>
            <ul>
              <li><i class="bi bi-check-circle"></i> <span>Blouse</span></li>
              <li><i class="bi bi-check-circle"></i> <span>Kemeja</span></li>
              <li><i class="bi bi-check-circle"></i> <span>Jumputan</span></li>
              <li><i class="bi bi-check-circle"></i> <span>Pakaian Jadi
                berbahan Kain</span></li>
            </ul>
            <p>
                Orderan tepat waktu, kualitas jahitan tiada tanding         
            </p>
          </div>
          ...
          <div class="col-lg-6 about-images" data-aos="fade-up" data-aos-delay="200">
            <div class="row gy-4" style="margin-top: 70px">
              <div class="col-lg-6 mt-6">
                <img src="assets/img/aidil/1.png" class="img-fluid" alt="">
              </div>
              <div class="col-lg-6">
                <div class="row gy-4">
                  <div class="col-lg-12">
                    <img src="assets/img/aidil/2.png" class="img-fluid" alt="">
                  </div>
                  {{-- <div class="col-lg-12">
                    <img src="assets/img/aidil/4.png" class="img-fluid" alt="">
                  </div> --}}
                </div>
              </div>
            </div>
    ...
    <section id="features" class="features section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Tentang Aidil Konveksi</h2>
        {{-- <p>Aidil Konveksi membuka peluang bagi investor untuk
            ...
            <ul class="nav nav-tabs" data-aos="fade-up" data-aos-delay="100">
                ...
                <a class="nav-link active show" data-bs-toggle="tab" data-bs-target="#features-tab-1">
                  ...
                  <div>
                    ...
                    <p>
                        ...
                        Perdagangan Eceran Pelengkap
                        Pakaian yang dapat dimitrakan
                        dengan sentra penjahit
                    </p>
                  </div>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" data-bs-target="#features-tab-2">
                  ...
                  <div>
                    <h4 class="d-none d-lg-block">Orderan</h4>
                    <p>
                        Orderan partai
                        besar, selesai
                        pekerjaan tepat
              ...
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" data-bs-target="#features-tab-3">
                  ...
                  <div>
                    <h4 class="d-none d-lg-block">Produk</h4>
                    <p>
                        Kami yang tidak
                        pernah menyematkan
                        nama pada jahitan,
                        tapi produk kami
                        beredar di pusatpusat perbelanjaan,
                        khususnya Kota
                        Palembang
                    </p>
                  </div>
          ...
          <div class="col-lg-6">
            ...
            <div class="tab-content" data-aos="fade-up" data-aos-delay="200">
              ...
              <div class="tab-pane fade active show" id="features-tab-1">
                <img src="assets/img/aidil/4.png" alt="" style="margin-top:70px" class="img-fluid">
              </div><!-- End Tab Content Item -->

              <div class="tab-pane fade" id="features-tab-2">
                <img src="assets/img/aidil/1.png" alt="" style="margin-top:70px" class="img-fluid">
              </div><!-- End Tab Content Item -->

              <div class="tab-pane fade" id="features-tab-3">
                <img src="assets/img/aidil/2.png" alt="" style="margin-top:70px" class="img-fluid">
              </div><!-- End Tab Content Item -->
            </div>
      ...
      <div class="container">
        ...
        <div class="row gy-4 justify-content-between features-item">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            <img src="assets/img/aidil/c1.png" class="img-fluid" alt="" style="max-height : 450px; max-width: 450px">
          </div>
        ...
        {{-- <div class="row gy-4 justify-content-between features-item">
          ...
          <div class="col-lg-5 d-flex align-items-center order-2 order-lg-1" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="content">
              <h3>Media Sosial</h3>
              <p>
                Sekilas Tentang Usaha Aidil Konveksi
              </p>
              <ul>
          ...
          <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-up" data-aos-delay="200">
            <img src="assets/img/aidil/c4.png" class="img-fluid" alt="">
          </div>
        ...
        <div class="row g-5">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-item item-orange position-relative">
              ...
              <div>
                ...
                <p>(a) Blouse, (b) Kemeja, (c)
                    Jumputan, (d) Pakaian Jadi
                    berbahan Kain</p>
                {{-- <a href="#" class="read-more stretched-link">Learn More <i class="bi bi-arrow-right"></i></a> --}}
              </div>
            </div>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="500">
            <div class="service-item item-indigo position-relative">
              ...
              <div>
                <h5>Omset</h5>
                <p>IDR. 20.000.000 - 30.000.000,-/bulan/p>
                {{-- <a href="#" class="read-more stretched-link">Learn More <i class="bi bi-arrow-right"></i></a> --}}
              </div>
            </div>
          </div><!-- End Service Item -->
    ...
    <div class="row gy-4">
      <div class="col-lg-6">
        <div class="info-item d-flex flex-column justify-content-center align-items-center" data-aos="fade-up" data-aos-delay="200">
          ...
          <h3>Alamat</h3>
          <p>Desa Ulak Kerbau Lama, Kec.
            Tj. Raja, Ogan Ilir - Sumatera
            Selatan</p>
        </div>
      </div><!-- End Info Item -->
