  ...
  <main class="main">
    ...
    <section id="hero" class="hero section">
      ...
      <div class="container text-center">
        <div class="d-flex flex-column justify-content-center align-items-center">
          <h1 data-aos="fade-up">Profile UMKM</br><span>Pandai Besi Bustami Jaya</span></h1>
          ...
          <div class="col-xl-3 col-lg-6" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item d-flex">
              ...
              <div>
                ...
                <p class="description">Bustami Jaya</p>
              </div>
            </div>
          </div>
          <!-- End Service Item -->
          ...
          <div class="col-xl-3 col-lg-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-item d-flex">
              ...
              <div>
                ...
                <p class="description">1999 /24 tahun</p>
              </div>
            </div>
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6 content" data-aos="fade-up" data-aos-delay="100">
            <p class="who-we-are">Produk Pandai Besi Bustami Jaya</p>
            <h3>Bustami jaya salah satu dari
              sekian banyaknya pandai besi
              di Desa Tanjung Pinang,
              Kabupaten Ogan Ilir. </h3>
            <p class="fst-italic">
              Produk Pandai Besi Bustami Jaya :
            </p>
            <ul>
          ...
          <div class="col-lg-6 about-images" data-aos="fade-up" data-aos-delay="200">
            <div class="row gy-4">
              <div class="col-lg-6 mt-6">
                <img src="assets/img/pandaibesi/c2.jpg" class="img-fluid" alt="">
              </div>
              <div class="col-lg-6">
                <div class="row gy-4">
                  <div class="col-lg-12">
                    <img src="assets/img/pandaibesi/c3.jpg" class="img-fluid" alt="">
                  </div>
                  <div class="col-lg-12">
                    <img src="assets/img/pandaibesi/c1.jpg" class="img-fluid" alt="">
                  </div>
                </div>
              </div>
            </div>
    ...
    <section id="features" class="features section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Tentang Pandai Besi Bustami Jaya</h2>
        <p>Pandai Besi Bustami Jaya membuka peluang bagi investor untuk
            ...
            <ul class="nav nav-tabs" data-aos="fade-up" data-aos-delay="100">
              <li class="nav-item">
                <a class="nav-link active show" data-bs-toggle="tab" data-bs-target="#features-tab-1">
                  ...
                  <div>
                    ...
                    <p>
                      Terdapat 10 unit usaha yang
                      bergerak dalam sektor perkebunan
                      ,Terdapat 6 unit usaha yang bergerak
                      dalam bidang perdagangan alat-alat
                      pertanian dan perkebunan
                      ,Terdapat 1 unit usaha
                      yang bergerak dalam
                      bidang penjualan besi
                      ,Terdapat 10 unit usaha
                      yang bergerak dalam
                      sektor perkebunan
                    </p>
                  </div>
              ...
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" data-bs-target="#features-tab-2">
                  ...
                  <div>
                    <h4 class="d-none d-lg-block">Rantai Pasok</h4>
                    <p>
                     1. Limbah Serbuk Kayu </br>
                     2. Toko Besi </br>
                     3. Scrap </br>
                    </p>
                  </div>
          ...
          <div class="col-lg-6">
            ...
            <div class="tab-content" data-aos="fade-up" data-aos-delay="200">
              ...
              <div class="tab-pane fade active show" id="features-tab-1">
                <img src="assets/img/pandaibesi/c4.jpg" alt="" style="margin-top:70px" class="img-fluid">
              </div><!-- End Tab Content Item -->

              <div class="tab-pane fade" id="features-tab-2">
                <img src="assets/img/pandaibesi/c1.jpg" alt="" style="margin-top:70px" class="img-fluid">
              </div><!-- End Tab Content Item -->

              <div class="tab-pane fade" id="features-tab-3">
                <img src="assets/img/pandaibesi/c3.jpg" alt="" style="margin-top:70px" class="img-fluid">
              </div><!-- End Tab Content Item -->
            </div>
      ...
      <div class="container">
        ...
        <div class="row gy-4 justify-content-between features-item">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            <img src="assets/img/pandaibesi/c1.jpg" class="img-fluid" alt="" style="max-height : 450px; max-width: 450px">
          </div>
        ...
        {{-- <div class="row gy-4 justify-content-between features-item">
          ...
          <div class="col-lg-5 d-flex align-items-center order-2 order-lg-1" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="content">
              <h3>Media Sosial</h3>
              <p>
                Sekilas Tentang Usaha Pandai Besi Bustami Jaya
              </p>
              <ul>
          ...
          <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-up" data-aos-delay="200">
            <img src="assets/img/pandaibesi/c4.jpg" class="img-fluid" alt="">
          </div>
        ...
        <div class="row g-5">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item item-cyan position-relative">
              ...
              <div>
                <h5>Bidang Usaha</h5>
                <p>Industri Alat Potong dan Perkakas
                  Tangan Pertukangan – Pandai Besi</p>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-item item-orange position-relative">
              ...
              <div>
                ...
                <p>(a) Dodos (tersedia 5 ukuran dari
                  Rp 55.000- Rp 80.000), (b) Egrek
                  (Rp 175.000), (c) Parang (Rp
                  50.000), Alat perkebunan</p>
                {{-- <a href="#" class="read-more stretched-link">Learn More <i class="bi bi-arrow-right"></i></a> --}}
              </div>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="600">
            <div class="service-item item-pink position-relative">
              ...
              <div>
                <h5>Pemasaran</h5>
                <p>Regional sumatera dan kalimantan</p>
                {{-- <a href="#" class="read-more stretched-link">Learn More <i class="bi bi-arrow-right"></i></a> --}}
              </div>
            </div>
          </div><!-- End Service Item -->
    ...
    <div class="row gy-4">
      <div class="col-lg-6">
        <div class="info-item d-flex flex-column justify-content-center align-items-center" data-aos="fade-up" data-aos-delay="200">
          ...
          <h3>Alamat</h3>
          <p>Tanjung Pinang I-Tanjung Batu,
