  ...
  <main class="main">
    ...
    <section id="hero" class="hero section">
      ...
      <div class="container text-center">
        <div class="d-flex flex-column justify-content-center align-items-center">
          <h1 data-aos="fade-up">Profile UMKM</br><span>Faaza Catering</span></h1>
          ...
          <div class="col-xl-3 col-lg-6" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item d-flex">
              ...
              <div>
                ...
                <p class="description">Rozalina Hasan</p>
              </div>
            </div>
          </div>
          <!-- End Service Item -->
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6 content" data-aos="fade-up" data-aos-delay="100">
            <p class="who-we-are">Produk Faaza Catering</p>
            <h3>UMKM hidangan saji makanan
                berat /utama dan makanan
                ringan</h3>
            <p class="fst-italic">
              Produk Faaza Catering :
            </p>
            <ul>
              <li><i class="bi bi-check-circle"></i> <span>Singkong Meledax</span></li>
              <li><i class="bi bi-check-circle"></i> <span>Nasi Box</span></li>
              <li><i class="bi bi-check-circle"></i> <span>Lenjer Gabus</span></li>
              <li><i class="bi bi-check-circle"></i> <span>Kapal Selam</span></li>
            </ul>
            <p>
                Dengan	kapasitas	produksi	
                100	kg	ikan	(pempek)	dan	
                300	nasi	kotak/bulan,	
                menjadikan	Faaza	Catering	
                sebagai	salah	satu	catering	
                berdaya	saing	dii	Indralaya	-
                Ogan	Ilir	dengan	pangsa	
                pasar	(market)	luas	dan	besar             
            </p>
          </div>
          ...
          <div class="col-lg-6 about-images" data-aos="fade-up" data-aos-delay="200">
            <div class="row gy-4" style="margin-top: 50px">
              <div class="col-lg-6 mt-6">
                <img src="assets/img/faaza/2.jpg" class="img-fluid" alt="">
              </div>
              <div class="col-lg-6">
                <div class="row gy-4">
                  <div class="col-lg-12">
                    <img src="assets/img/faaza/1.jpg" class="img-fluid" alt="">
                  </div>
                  {{-- <div class="col-lg-12">
                    <img src="assets/img/faaza/1.jpg" class="img-fluid" alt="">
                  </div> --}}
    ...
    <section id="features" class="features section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Tentang Faaza Catering</h2>
        {{-- <p>Faaza Catering membuka peluang bagi investor untuk
            ...
            <ul class="nav nav-tabs" data-aos="fade-up" data-aos-delay="100">
              <li class="nav-item">
                <a class="nav-link active show" data-bs-toggle="tab" data-bs-target="#features-tab-1">
                  ...
                  <div>
                    ...
                    <p>
                      Terdapat 62 perusahaan
                      yang dapat dimitrakan
                      dalam kebutuhan
                      catering karyawan
                    </p>
                  </div>
              ...
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" data-bs-target="#features-tab-2">
                  ...
                  <div>
                    <h4 class="d-none d-lg-block">Harapan</h4>
                    <p>
                        Saat ini, Faaza Catering
                        belum ada kemitraan
                        dengan UMKM lainnya,
                        dan ingin membuka
                        peluang kemitraan
              ...
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" data-bs-target="#features-tab-3">
                  ...
                  <div>
                    <h4 class="d-none d-lg-block">Pelayanan</h4>
                    <p>
                        Sejak	berdiri	tahun	2017,	
                        Faaza	Catering	telah	melayani	
                        berbagai	permintaan	hidangan	
                        saji	dalam	berbagai	acara,	
                        seperti:	akikahan,	pernikahan,	
                        pesta	ultah,	sunatan,	dan	
                        berbagai	agenda	meeting
                        (pemerintahan	/swasta)	
                    </p>
                  </div>
                </a>
          ...
          <div class="col-lg-6">
            ...
            <div class="tab-content" data-aos="fade-up" data-aos-delay="200">
              ...
              <div class="tab-pane fade active show" id="features-tab-1">
                <img src="assets/img/faaza/1.jpg" alt="" style="margin-top:70px" class="img-fluid">
              </div><!-- End Tab Content Item -->

              <div class="tab-pane fade" id="features-tab-2">
                <img src="assets/img/faaza/2.jpg" alt="" style="margin-top:70px" class="img-fluid">
              </div><!-- End Tab Content Item -->

              <div class="tab-pane fade" id="features-tab-3">
                <img src="assets/img/faaza/3.jpg" alt="" style="margin-top:70px" class="img-fluid">
              </div><!-- End Tab Content Item -->
            </div>
      ...
      <div class="container">
        ...
        <div class="row gy-4 justify-content-between features-item">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            <img src="assets/img/faaza/1.jpg" class="img-fluid" alt="" style="max-height : 450px; max-width: 450px">
          </div>
        ...
        {{-- <div class="row gy-4 justify-content-between features-item">
          ...
          <div class="col-lg-5 d-flex align-items-center order-2 order-lg-1" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="content">
              <h3>Media Sosial</h3>
              <p>
                Sekilas Tentang Usaha Faaza Catering
              </p>
              <ul>
          ...
          <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-up" data-aos-delay="200">
            <img src="assets/img/faaza/c4.jpg" class="img-fluid" alt="">
          </div>
        ...
        <div class="row g-5">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item item-cyan position-relative">
              ...
              <div>
                <h5>Bidang Usaha</h5>
                <p>Jasa Boga Untuk Suatu Event Tertentu
                    (Event Catering)</p>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-item item-orange position-relative">
              ...
              <div>
                ...
                <p>(a) Singkong meledax, (b) nasi box, (c)
                    Lenjer gabus, (d) kapal selam, (e)
                    pempek negro, (f) Tumpeng spesiallle,
                    (g) Nasi arab, (h) pempek ikan gabus,
                    (i) aneka pempek kecil kakap</p>
                {{-- <a href="#" class="read-more stretched-link">Learn More <i class="bi bi-arrow-right"></i></a> --}}
              </div>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="300">
            <div class="service-item item-teal position-relative">
              ...
              <div>
                ...
                <p>Pempek: 100 kg ikan /bulan dan
                    catering: 300 box /bulan</p>
                {{-- <a href="#" class="read-more stretched-link">Learn More <i class="bi bi-arrow-right"></i></a> --}}
              </div>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="400">
            <div class="service-item item-red position-relative">
              ...
              <div>
                ...
                <p> Belum ada, sementara via teman ke teman</p>
                {{-- <a href="#" class="read-more stretched-link">Learn More <i class="bi bi-arrow-right"></i></a> --}}
              </div>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="600">
            <div class="service-item item-pink position-relative">
              ...
              <div>
                ...
                <p>Sama dengan kapasitas produksi</p>
                {{-- <a href="#" class="read-more stretched-link">Learn More <i class="bi bi-arrow-right"></i></a> --}}
              </div>
            </div>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="600">
            <div class="service-item item-pink position-relative">
              ...
              <div>
                <h5>Pemasaran</h5>
                <p>Catering: indralaya, palembang dsk,
                    pempek: palembang, jabodetabek,
                    semaran dan surabaya</p>
                {{-- <a href="#" class="read-more stretched-link">Learn More <i class="bi bi-arrow-right"></i></a> --}}
              </div>
            </div>
          </div><!-- End Service Item -->
    ...
    <div class="row gy-4">
      <div class="col-lg-6">
        <div class="info-item d-flex flex-column justify-content-center align-items-center" data-aos="fade-up" data-aos-delay="200">
          ...
          <h3>Alamat</h3>
          <p>Permata Duma blok E No. 12, Indralaya
            Raya - Inderalaya, Ogan Ilir Sumatera Selatan</p>
        </div>
      </div><!-- End Info Item -->
      ...
      <div class="col-lg-3 col-md-6">
        <div class="info-item d-flex flex-column justify-content-center align-items-center" data-aos="fade-up" data-aos-delay="400">
          ...
          <h3>Email</h3>
          <p>faazafadhilfathinfathiah2020@gmail.co</p>
        </div>
      </div><!-- End Info Item -->
    </div>
